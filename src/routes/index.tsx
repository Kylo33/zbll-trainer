        ...
        <div className='col-span-2 flex flex-col gap-4'>
          <Card>
            <CardHeader>
              ...
              <CardAction><Button variant={'outline'}><SkipForward />Skip</Button></CardAction>
            </CardHeader> 
            <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Interact with the 3D cube below to view its current state and orientation.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div ref={cubeDiv} className='w-full aspect-[4/3]'></div>
            </CardContent>
          </Card>
        </div>
        ...
        <CardContent>
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell><span className="font-mono py-1 px-2 bg-muted rounded-sm">R U R' U' R' F R2 U' R' U' R U R' F'</span></TableCell>
              </TableRow>
              <TableRow>
                <TableCell className="font-medium">U-31</TableCell>
                <TableCell>10.87s</TableCell>
                <TableCell><span className="font-mono py-1 px-2 bg-muted rounded-sm">F R U' R' U' R U R' F' R U R' U' R' F R2</span></TableCell>
              </TableRow>
              <TableRow>
                <TableCell className="font-medium">L-12</TableCell>
                <TableCell>14.02s</TableCell>
                <TableCell><span className="font-mono py-1 px-2 bg-muted rounded-sm">U2 R2 F2 U' R2 U2 R2 U' F2 U2</span></TableCell>
              </TableRow>
              <TableRow>
                <TableCell className="font-medium">S-1</TableCell>
                <TableCell>11.56s</TableCell>
                <TableCell><span className="font-mono py-1 px-2 bg-muted rounded-sm">R' U' F U R U' R' F' R2 U R'</span></TableCell>
              </TableRow>
            </TableBody>
            </Table>
        </CardContent>
